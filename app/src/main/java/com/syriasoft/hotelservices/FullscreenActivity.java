            ...
            public void onClick(View view) {
                if (THEROOM.getSERVICE1_B() != null) {
                    if (THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.laundryButton)) != null) {
                        if (Boolean.parseBoolean(Objects.requireNonNull(THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.laundryButton))).toString())) {
            ...
            public void onClick(View view) {
                if (THEROOM.getSERVICE1_B() != null) {
                    if (THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.cleanupButton)) != null) {
                        if (Boolean.parseBoolean(Objects.requireNonNull(THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.cleanupButton))).toString())) {
            ...
            public void onClick(View view) {
                if (THEROOM.getSERVICE1_B() != null) {
                    if (THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.checkoutButton)) != null) {
                        if (Boolean.parseBoolean(Objects.requireNonNull(THEROOM.getSERVICE1_B().dps.get(String.valueOf(MyApp.ProjectVariables.checkoutButton))).toString())) {
            ...
            public void onClick(View view) {
                if (THEROOM.getSERVICE1_B() != null) {
                    if (THEROOM.getSERVICE1_B().getDps().get(String.valueOf(MyApp.ProjectVariables.dndButton)) != null) {
                        if (Boolean.parseBoolean(Objects.requireNonNull(THEROOM.getSERVICE1_B().getDps().get(String.valueOf(MyApp.ProjectVariables.dndButton))).toString())) {
...
//                    if (MY_SCENES.get(i).getName().contains("Sleep Mood") || MY_SCENES.get(i).getName().contains("Living Mood")) {
//                        TuyaHomeSdk.newSceneInstance(MY_SCENES.get(i).getId()).deleteScene(new IResultCallback() {
//                            @Override
//                            public void onError(String code, String error) {
//
//                            }
...
//                            });
    ...
    void addLightsButton(String name,int button,DeviceBean D,ITuyaDevice T,String switchNum) {
        LinearLayout LightButton = new LinearLayout(act);
        LightButton.setOrientation(LinearLayout.VERTICAL);
        TextView text = new TextView(act);
        Button image = new Button(act);
        ...
        if (button == 1) {
            if (D.dps.get("1") != null) {
                RoomDevicesRef.child(D.getName()).child("1").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getValue() != null) {
                            switch (switchNum) {
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (switchNum) {
                        case "1":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S1B1);
                            break;
                        case "2":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S2B1);
                            break;
                        case "3":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S3B1);
                            break;
                        case "4":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S4B1);
                            break;
                    }
                    x=0;
                }
        ...
        if (button == 2) {
            if (D.dps.get("2") != null) {
                RoomDevicesRef.child(D.getName()).child("2").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getValue() != null) {
                            switch (switchNum) {
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (switchNum) {
                        case "1":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S1B2);
                            break;
                        case "2":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S2B2);
                            break;
                        case "3":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S3B2);
                            break;
                        case "4":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S4B2);
                            break;
                    }
                    x=0;
                }
        ...
        if (button == 3) {
            if (D.dps.get("3") != null) {
                RoomDevicesRef.child(D.getName()).child("3").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getValue() != null) {
                            switch (switchNum) {
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (switchNum) {
                        case "1":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S1B3);
                            break;
                        case "2":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S2B3);
                            break;
                        case "3":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S3B3);
                            break;
                        case "4":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S4B3);
                            break;
                    }
                    x=0;
                }
        ...
        if (button == 4) {
            if (D.dps.get("4") != null) {
                RoomDevicesRef.child(D.getName()).child("4").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.getValue() != null) {
                            switch (switchNum) {
                                case "1":
                                    ...
                                    break;
                                case "2":
                                    clickSwitchButton(T, String.valueOf(button),THEROOM.S2B4);
                                    if (Integer.parseInt(snapshot.getValue().toString()) == 3 || Integer.parseInt(snapshot.getValue().toString()) == 1) {
                                        THEROOM.S2B4 = true ;
                                        makeSwitchOn(text,image);
                                    }
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (switchNum) {
                        case "1":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S1B4);
                            break;
                        case "2":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S2B4);
                            break;
                        case "3":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S3B4);
                            break;
                        case "4":
                            clickSwitchButton(T, String.valueOf(button),THEROOM.S4B4);
                            break;
                    }
                    x=0;
                }
