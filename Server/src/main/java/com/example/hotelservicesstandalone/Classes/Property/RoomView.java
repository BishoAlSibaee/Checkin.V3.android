...
import com.example.hotelservicesstandalone.ReceptionScreen;
...
public class RoomView extends LinearLayout {
    ...
    public View createRoomView() {
        ...
        powerOff.setOnClickListener(view ->{
            room.getPowerModule().powerOff(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
        ...
        powerCard.setOnClickListener(view->{
            room.getPowerModule().powerByCard(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
        ...
        powerOn.setOnClickListener(view->{
            room.getPowerModule().powerOn(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
    ...
    public View createSuiteView() {
        ...
        powerCard.setScaleType(ImageView.ScaleType.FIT_CENTER);
        powerOff.setOnClickListener(view ->{
            suite.getPowerModule().powerOff(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
        ...
        powerCard.setOnClickListener(view->{
            suite.getPowerModule().powerByCard(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
        ...
        powerOn.setOnClickListener(view->{
            suite.getPowerModule().powerOn(new IResultCallback() {
                @Override
                public void onError(String code, String error) {
