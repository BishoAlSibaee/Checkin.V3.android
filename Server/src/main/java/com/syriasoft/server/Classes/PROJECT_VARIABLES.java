...
import com.syriasoft.server.Classes.Interfaces.GetStops;
...
public class PROJECT_VARIABLES {
    ...
    public static int cleanupButton,laundryButton,dndButton,checkoutButton,lightButton;
    ...
    public static void setServiceSwitchButtons(JSONObject serviceSwitchButtons) throws JSONException {
        ...
        if (serviceSwitchButtons.getInt("light") != 0) {
            lightButton = serviceSwitchButtons.getInt("light");
        }
    }
