...
import com.syriasoft.server.Classes.Interfaces.ProjectLoginCallback;
...
Login extends AppCompatActivity {
    ...
    void goToRooms() {
        if (MyApp.My_PROJECT != null) {
            Intent i;
            if (MyApp.My_PROJECT.projectName.equals("P0002")) {
                i = new Intent(act , ReceptionScreen.class);
            }
            else {
                i = new Intent(act , Rooms.class);
            }
            act.startActivity(i);
            act.finish();
        }
