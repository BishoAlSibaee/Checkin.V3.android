...
public class ROOM {
    ...
    void setGuestIs(int is) {
        this.guestIs = is;
    }

    void getRoomServiceText(RoomServiceCallback callback) {
        getFireRoom().child("RoomServiceText").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
