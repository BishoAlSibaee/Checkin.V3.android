...
//    public static DeviceBean SelectedSwitch ;
    ...
    void getButtons() {
        ...
        Buttons.clear();
        DatabaseReference roomButtons = Rooms.database.getReference("/"+MyApp.THE_PROJECT.projectName+"/B"+RoomManager.Room.Building+"/F"+RoomManager.Room.Floor+"/R"+RoomManager.Room.RoomNumber+"/Buttons");
