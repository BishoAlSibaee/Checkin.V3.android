...
import com.syriasoft.mobilecheckdevice.Classes.Interfaces.GetSuitesCallBack;
...
public class Suite extends Bed {
    ...
    Building building;
    com.syriasoft.mobilecheckdevice.Classes.Property.Floor floor;
...
//        });
    ...
    public static void getSuites(PROJECT project, RequestQueue Q, GetSuitesCallBack callBack) {
        List<Suite> suites = new ArrayList<>();
        Q.add(new StringRequest(Request.Method.GET,  project.url+getSuitesUrl, response -> {
            try {
