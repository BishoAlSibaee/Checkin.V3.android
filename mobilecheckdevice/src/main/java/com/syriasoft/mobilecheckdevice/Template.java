...
import com.syriasoft.mobilecheckdevice.Interface.CreateMoodCallBack;
import com.syriasoft.mobilecheckdevice.Interface.CreateMultiControlCallBack;
import com.syriasoft.mobilecheckdevice.Interface.CreateMultiControlsCallBack;
...
public class Template {
    ...
    void createTemplateMoodInRoom(TemplateMood md, ROOM room, CreateMoodCallBack callBack) {
        ...
        ROOM.getRoomHome(room, MyApp.PROJECT_HOMES, new HomeBeanCallBack() {
            @Override
