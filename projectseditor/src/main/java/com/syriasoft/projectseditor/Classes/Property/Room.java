...
import com.syriasoft.projectseditor.Interfaces.GetReservationType;
...
//    List<CheckinLock> locks;
    ...
    public void setFireRoom(FirebaseDatabase database,PROJECT project) {
        fireRoom = database.getReference(project.projectName+"/B"+building.buildingNo+"/F"+floor.floorNumber+"/R"+RoomNumber);
...
//    }
    ...
    public static void setRoomsFireRooms(List<Room> rooms,FirebaseDatabase database,PROJECT project) {
        for (Room r :rooms) {
            r.setFireRoom(project,database);
        }
    }
...
//            //Log.d("checkinMood"+room.RoomNumber,"p0003");
//            if (isHasSwitch()) {
//                for (CheckinSwitch cs : switches) {
//                    if (cs.device.name.contains("Switch3")) {
//                        Log.d("checkinMood","switch found done ");
//                        cs.dp1.turnOn(new IResultCallback() {
//                            @Override
//                            public void onError(String code, String error) {
//                                Log.d("lightsOn",error);
